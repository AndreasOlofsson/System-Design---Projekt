    ...
    if(arr.length === 0){
      ...
      for(i; i < arr.length; i++){
        ...
        if(document.getElementById(clicked_id).name === arr[i]){
          console.log("same");
          /*var old = arrAmount[i], parent = old.parentNode;
          var newone = document.createElement('div');
          newone = arrAmount[i]++;
          parent.replaceChild(newone, old);*/
          break;
        }
...
function displayOrder(){
  ...
  var th = document.createElement('TH');
  tr1.appendChild(th);
  var buttonSend = createSendButton('http://www.msqq.com/d/file/icon/2014-03-16/78c02c76dc38ab93150d517835cb9017.png', 'send', 'send1');
